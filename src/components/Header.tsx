...
const Header: React.FC = () => {
  return <header className="fixed top-0 left-0 right-0 z-50 flex justify-center items-start pt-4 md:pt-6 backdrop-blur supports-[backdrop-filter]:bg-black/10 py-[105px]">
