    ...
    <section id="tos" className="py-24 px-6 border-t border-border/50">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          <p>
            Welcome to Pixel Cloud9. By using our website, services, or products,
            you agree to comply with and be bound by these Terms of Service.
            Pixel Cloud9 provides automation, web design, and AI systems to help
            businesses operate efficiently.
          </p>
          <p>You agree not to misuse our website or services.</p>
          <p>
            Payments for services or digital products are non-refundable unless
            otherwise stated in writing.
          </p>
          <p>
            Pixel Cloud9 is not liable for any indirect or consequential damages
