...
const Index = () => {
  ...
  const osLayers = [{
    ...
    desc: "Calls, forms, chat, and Google leads captured instantly."
  }, {
    icon: Brain,
    title: "Intelligence",
    metric: "Auto follow-up",
    desc: "AI qualifies, routes, and follows up automatically."
  }, {
    icon: LineChart,
    title: "Growth",
    metric: "Revenue increase",
    desc: "More bookings, better retention, higher revenue."
  }];
      ...
      <section className="py-10 md:py-16 px-4 md:px-6 bg-muted/30">
        <div className="container mx-auto max-w-7xl text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-8 lg:gap-12 opacity-60">
            {[gohighlevelLogo, twilioLogo, calendlyLogo, openaiLogo, zapierLogo, makeLogo, stripeLogo, gmailLogo].map((logo, i) => <img key={i} src={logo} alt="Integration" className="h-6 md:h-8 grayscale hover:grayscale-0 transition-all" />)}
          </div>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid md:grid-cols-2 gap-3 md:gap-6 text-left">
            {["Missed calls when you're busy or after hours", "Leads not getting followed up", "Website traffic that doesn't turn into bookings", "Google Maps visibility dropping", "Too many tools that don't talk to each other", "Spending hours on manual scheduling and reminders"].map(pain => <div key={pain} className="flex items-start gap-3 apple-card p-3 md:p-4">
      ...
      <section id="services" className="section-padding bg-muted/30">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            href: "/services"
          }].map((service, i) => <div key={service.title} className="apple-card p-4 md:p-6 flex flex-col fade-in" style={{
      ...
      <section id="os" className="section-padding">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="hidden md:flex items-start justify-between gap-8">
            {osLayers.map((layer, i) => <div key={layer.title} className="os-layer flex-1 fade-in" style={{
          ...
          <div className="md:hidden">
            <Accordion type="single" collapsible className="space-y-3">
              {osLayers.map((layer, i) => <AccordionItem key={layer.title} value={layer.title} className="apple-card border-0">
